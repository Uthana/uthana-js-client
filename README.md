...
`text-to-motion-3.0` runs as an async job and returns a `Job` to poll — the same pattern as video-to-motion. Available to any account on the [pay-as-you-go plan](https://uthana.com/docs/api/pricing).
